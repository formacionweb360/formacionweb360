      ...
      order: () => ({
        then: (callback) => {
          const mockData = Array.from({ length: 45 }, (_, i) => ({
            ...
            nombre: `Usuario ${i + 1}`,
            usuario: `user${i + 1}`,
            grupo_nombre: ['Grupo A', 'Grupo B', 'Grupo C'][i % 3],
            estado: i % 10 === 0 ? 'Inactivo' : 'Activo',
            dia_1: ['ASISTIÓ', 'FALTA', 'TARDANZA', null][i % 4],
            dia_2: ['ASISTIÓ', 'ASISTIÓ', 'DESERTÓ', null][i % 4],
            dia_3: ['ASISTIÓ', 'FALTA', 'ASISTIÓ', 'TARDANZA'][i % 4],
            dia_4: ['ASISTIÓ', 'ASISTIÓ', 'NO SE PRESENTÓ', null][i % 4],
            dia_5: ['ASISTIÓ', 'TARDANZA', 'ASISTIÓ', 'FALTA'][i % 4],
            dia_6: ['ASISTIÓ', 'ASISTIÓ', 'RETIRADO', null][i % 4],
          }));
...
export default function AdminPage({ user = { rol: "Administrador" } }) {
